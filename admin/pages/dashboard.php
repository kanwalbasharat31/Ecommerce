          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                ...
                <?php  
                $fetch_cont = "SELECT * FROM `user_contact_us`";
                $run_cont = mysqli_query($conn, $fetch_cont);
                $count_cont = mysqli_num_rows($run_cont);
                ?>
                <h4 class="mb-0"><?php echo $count_cont ; ?></h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
          </div>
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                ...
                <?php  
                $fetch_emp = "SELECT * FROM `user_contact_us`";
